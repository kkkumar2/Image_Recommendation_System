...
class NoramlfeatureextractorPytroch:
    def __init__(self,config,params):
        ...
        annoy_name = config['artifacts']["annoy_pt"]
        ...
        self.annoy_path = os.path.join(artifact_dir, meta_data_dir, annoy_name)
    ...
    def create_annoy_index(self,features):
    ...
    def get_features_normal(self):
        ...
        self.create_annoy_index(features)
...
class NoramlfeatureextractorTensorflow:
    def __init__(self,config):
        ...
        annoy_name = config['artifacts']["annoy_tf"]
...
class SearchImageNormalPytoch:
    def __init__(self,config,params):
        ...
        self.u = AnnoyIndex(self.vectorsten[0].shape[0], 'angular')
    ...
    def get_similar_images_normal_Annoy(self,img):
        featurevector = self.FE.extract(img)
